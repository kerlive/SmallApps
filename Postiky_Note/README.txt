Postiky Note is a small encrypto note application

you can easy to creat adding notes simply
...
软件名‘便签本’， 可快速生成随笔并附带加密功能。

点击add 生成笔记写下并关闭可以保存草稿， （如果你不想丢失笔记请不要在保存它之前用系统托盘的'Quit'按钮退出程序）

在主界面可以点击笔记并在预览页面看到它，或者可以选择双击取出。

在主管理界面使用加密'encrypt'或删除'del'可以轻松管理草稿文件。
(如果不想丢失加密文件请在加密它前在备忘栏提供注释，并且不要使用英文以外的字符作为密码，那会让程序崩溃)

如果你想修改已加密的文档，双击它并输入正确的密码程序会复制一份到新的便签界面。

最后在便签界面点击加密锁可以在关闭界面后快速跳转至加密界面。
